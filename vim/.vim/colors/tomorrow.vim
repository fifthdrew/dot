...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("StatusLine", s:line, s:foreground, "reverse")
	call <SID>X("StatusLineNC", s:line, "", "reverse")
	call <SID>X("VertSplit", s:line, "", "none")
	...
	if version >= 703
		call <SID>X("ColorColumn", "", s:gray, "none")
	end
