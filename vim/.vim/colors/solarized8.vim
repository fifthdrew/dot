...
" Last Updated: seg 01 ago 2022 11:08:32
...
if &background ==# 'dark'
  ...
  if get(g:, 'solarized_diffmode', '') ==# 'high'
    ...
    hi DiffAdded guifg=#859900 guibg=NONE gui=reverse cterm=reverse
    ...
    hi DiffRemoved guifg=#dc322f guibg=NONE gui=reverse cterm=reverse
    hi DiffText guifg=#268bd2 guibg=NONE gui=reverse cterm=reverse
    hi DiffFile guifg=#839496 guibg=NONE gui=reverse cterm=reverse
  elseif get(g:, 'solarized_diffmode', '') ==# 'low'
    hi DiffAdd guifg=#859900 guibg=NONE guisp=#859900 gui=NONE cterm=NONE
    hi DiffAdded guifg=#859900 guibg=NONE guisp=#859900 gui=NONE cterm=NONE
    ...
    hi DiffRemoved guifg=#dc322f guibg=NONE gui=bold cterm=bold
    hi DiffText guifg=#268bd2 guibg=NONE guisp=#268bd2 gui=NONE cterm=NONE
    hi DiffFile guifg=#839496 guibg=NONE guisp=#839496 gui=NONE cterm=NONE
  else " normal diffmode
    hi DiffAdd guifg=#859900 guibg=NONE guisp=#859900 gui=NONE cterm=NONE
    hi DiffAdded guifg=#859900 guibg=NONE guisp=#859900 gui=NONE cterm=NONE
    hi DiffChange guifg=#b58900 guibg=NONE guisp=#b58900 gui=NONE cterm=NONE
    hi DiffDelete guifg=#dc322f guibg=NONE guisp=#dc322f gui=NONE cterm=NONE
    hi DiffRemoved guifg=#dc322f guibg=NONE guisp=#dc322f gui=NONE cterm=NONE
    hi DiffText guifg=#268bd2 guibg=NONE guisp=#268bd2 gui=NONE cterm=NONE
    hi DiffFile guifg=#839496 guibg=NONE gui=bold cterm=bold
    hi DiffIndexLine guifg=#839496 guibg=NONE gui=bold cterm=bold
    hi DiffLine guifg=#2aa198 guibg=NONE guisp=#2aa198 gui=NONE cterm=NONE
    hi DiffSubname guifg=#839496 guibg=NONE guisp=#839496 gui=NONE cterm=NONE
  endif
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    elseif get(g:, 'solarized_diffmode', '') ==# 'low'
      ...
      hi DiffText ctermfg=32 ctermbg=NONE cterm=NONE
      hi DiffFile ctermfg=246 ctermbg=NONE cterm=bold
      hi DiffIndexLine ctermfg=246 ctermbg=NONE cterm=bold
      hi DiffLine ctermfg=37 ctermbg=NONE cterm=NONE
      hi DiffSubname ctermfg=246 ctermbg=NONE cterm=NONE
    endif
    if get(g:, 'solarized_statusline', '') ==# 'low'
...
if s:t_Co >= 16
  if &background ==# 'dark'
    ...
    if get(g:, 'solarized_diffmode', '') ==# 'high'
      ...
      hi DiffAdded ctermfg=2 ctermbg=NONE cterm=reverse
      hi DiffChange ctermfg=3 ctermbg=NONE cterm=reverse
      hi DiffDelete ctermfg=1 ctermbg=NONE cterm=reverse
      hi DiffRemoved ctermfg=1 ctermbg=NONE cterm=reverse
      hi DiffText ctermfg=4 ctermbg=NONE cterm=reverse
      hi DiffFile ctermfg=12 ctermbg=NONE cterm=reverse
    elseif get(g:, 'solarized_diffmode', '') ==# 'low'
      ...
      hi DiffFile ctermfg=12 ctermbg=NONE cterm=NONE
    else " normal diffmode
      hi DiffAdd ctermfg=2 ctermbg=NONE cterm=NONE
      hi DiffAdded ctermfg=2 ctermbg=NONE cterm=NONE
      hi DiffChange ctermfg=3 ctermbg=NONE cterm=NONE
      ...
      hi DiffText ctermfg=4 ctermbg=NONE cterm=NONE
      hi DiffFile ctermfg=12 ctermbg=NONE cterm=bold
      hi DiffIndexLine ctermfg=12 ctermbg=NONE cterm=bold
      hi DiffLine ctermfg=6 ctermbg=NONE cterm=NONE
      hi DiffSubname ctermfg=12 ctermbg=NONE cterm=NONE
    endif
    if get(g:, 'solarized_statusline', '') ==# 'low'
