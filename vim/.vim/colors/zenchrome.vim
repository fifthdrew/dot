" SOURCE: https://shorturl.at/atDQW
...
let g:Colorscheme = {
  ...
  \
  \ 'Constant'   : { 'ctermfg': s:Foreground, 'cterm': 'Bold' },
  ...
  \ 'String'     : { 'ctermfg': s:Foreground, 'cterm': 'Italic' },
  \
  \ 'SpellBad'   : { 'links': 'Error' },
  \ 'SpellCap'   : { 'links': 'Error' },
  \ 'Todo'       : { 'ctermfg': s:LightYellow },
  \ 'WarningMsg' : { 'links': 'Error' },
  \
  \ 'IncSearch'  : { 'links': 'Search' },
  \
  \ 'Comment'    : { 'ctermfg': s:LightForeground, 'cterm': 'Italic' },
  \ 'Statement'  : { 'ctermfg': s:Foreground, 'cterm': 'Bold' },
  \ 'Include'    : { 'ctermfg': s:Foreground, 'cterm': 'Bold' },
  \ 'Delimiter'  : { 'ctermfg': s:DarkGrey },
  \ }
